...
class Attendance(models.Model):
    ...
    student = models.ForeignKey(
        "student.Student", verbose_name="Student", on_delete=models.CASCADE
    )
    marked_by = models.ForeignKey("teacher.Teacher", on_delete=models.CASCADE)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["student", "date"], name="unique_student_attendance_per_day"
            )
        ]
